...
public class Persoana extends Entity{
    ...
    public Persoana(long serialVersionUID, int id, String nume, String prenume, String username, String parola, Oras oras, String strada, String numarStrada, String telefon) {
